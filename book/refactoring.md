...
| 以函数调用取代内联代码| 函数替换内联代码  | [以函数调用取代内联代码](#ReplaceInlineCodeWithFunctionCall) |
...
<h3 id="ConsolidateConditionalExpression">合并条件表达式</h3>
...
<h3 id="IntroduceSpecialCase">引入特例</h3>
...
<h3 id="PreserveWholeObject">保持对象完整</h3>
